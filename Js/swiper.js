...
!function(e, t) {
    ...
    var o = {
        ...
        eq: function(e) {
            if (void 0 === e)
                return this;
            var t, a = this.length;
            return e > a - 1 ? new n([]) : e < 0 ? (t = a + e,
                new n(t < 0 ? [] : [this[t]])) : new n([this[e]])
        },
        append: function() {
            for (var e = this, t = [], a = arguments.length; a--; )
                t[a] = arguments[a];
        ...
        children: function(a) {
            for (var i = this, s = [], r = 0; r < this.length; r += 1)
                for (var o = i[r].childNodes, l = 0; l < o.length; l += 1)
    ...
    p.prototype.on = function(e, t) {
        ...
        p.prototype.emit = function() {
            for (var e = [], t = arguments.length; t--; )
                e[t] = arguments[t];
            var a, i, s, r = this;
            return "string" == typeof e[0] || Array.isArray(e[0]) ? (a = e[0],
    ...
    var u = {
            ...
            if (void 0 !== i) {
                ...
                for (var E, S = t.slidesPerColumn, C = T / S, M = C - (t.slidesPerColumn * C - o), z = 0; z < o; z += 1) {
                    ...
                    n[z] && (n[z].swiperSlideSize = E),
                        u.push(E),
                        t.centeredSlides ? (w = w + E / 2 + x / 2 + b,
                        0 === x && 0 !== z && (w = w - i / 2 - b),
                        0 === z && (w = w - i / 2 - b),
                        Math.abs(w) < .001 && (w = 0),
                        y % t.slidesPerGroup == 0 && p.push(w),
                            c.push(w)) : (y % t.slidesPerGroup == 0 && p.push(w),
                            c.push(w),
                            w = w + E + b),
                        e.virtualSize += E + b,
                        x = E,
                ...
                if (s && r && ("slide" === t.effect || "coverflow" === t.effect) && a.css({
                    ...
                    for (var D = 0; D < p.length; D += 1)
                        p[D] < e.virtualSize + p[0] && L.push(p[D]);
                    p = L
                }
                if (!t.centeredSlides) {
                    L = [];
                    for (var O = 0; O < p.length; O += 1)
                        p[O] <= e.virtualSize - i && L.push(p[O]);
                    p = L,
                ...
                p.length !== m && e.emit("snapGridLengthChange"),
        ...
        updateRealIndex: function() {
            var e = this
                , t = e.realIndex;
            e.realIndex = parseInt(e.slides.eq(e.activeIndex).attr("data-swiper-slide-index") || e.activeIndex, 10),
            t !== e.realIndex && e.emit("realIndexChange")
        },
        ...
        updateActiveIndex: function() {
            for (var e, t, a = this, i = a.rtl ? a.translate : -a.translate, s = a.slidesGrid, r = a.snapGrid, n = a.params, o = a.activeIndex, d = 0; d < s.length; d += 1)
                void 0 !== s[d + 1] ? i >= s[d] && i < s[d + 1] - (s[d + 1] - s[d]) / 2 ? e = d : i >= s[d] && i < s[d + 1] && (e = d + 1) : i >= s[d] && (e = d);
            n.normalizeSlideIndex && (e < 0 || void 0 === e) && (e = 0),
            (t = Math.floor(e / n.slidesPerGroup)) >= r.length && (t = r.length - 1),
            e !== o && (l.extend(a, {
                snapIndex: t,
                previousIndex: o,
                activeIndex: e
        ...
        setTranslate: function(e, t) {
            ...
            s.roundLengths && (o = Math.floor(o),
                l = Math.floor(l)),
            s.virtualTranslate || (d.transforms3d ? r.transform("translate3d(" + o + "px, " + l + "px, 0px)") : r.transform("translate(" + o + "px, " + l + "px)")),
                a.translate = a.isHorizontal() ? o : l;
            var p = a.maxTranslate() - a.minTranslate();
            (0 === p ? 0 : (e - a.minTranslate()) / p) !== n && a.updateProgress(e),
        ...
        slideTo: function(e, t, a, i) {
            ...
            var n = s.params
                ...
                , u = s.rtl
                , h = s.$wrapperEl;
            s.snapIndex = Math.floor(r / n.slidesPerGroup),
            s.snapIndex >= o.length && (s.snapIndex = o.length - 1),
            ...
            return !(!s.allowSlideNext && v < s.translate && v < s.minTranslate() || !s.allowSlidePrev && v > s.translate && v > s.maxTranslate() && (s.activeIndex || 0) !== r || (s.previousIndex = p || 0,
                s.activeIndex = r,
            d === r && p === r || (s.emit("activeIndexChange"),
                s.emit("slideChange")),
            c !== s.snapIndex && s.emit("snapIndexChange"),
                s.updateRealIndex(),
                u && -v === s.translate || !u && v === s.translate ? (n.autoHeight && s.updateAutoHeight(),
                    s.updateSlidesClasses(),
                "slide" !== n.effect && s.setTranslate(v),
                    1) : (s.updateSlidesClasses(),
                    s.emit("beforeTransitionStart", t, i),
                    s.transitionStart(a),
                    0 === t || f.lteIE9 ? (s.setTransition(0),
                        s.setTranslate(v),
        ...
        prependSlide: function(e) {
            ...
            if ("object" == typeof e && "length"in e) {
                ...
                i.prepend(e);
            a.loop && t.loopCreate(),
            a.observer && d.observer || t.update(),
                t.slideTo(r, 0, !1)
        },
        ...
        if (a && (t.os = "windows",
            ...
            t.ios && t.osVersion && e.indexOf("Version/") >= 0 && "10" === t.osVersion.split(".")[0] && (t.osVersion = e.toLowerCase().split("version/")[1].split(" ")[0]),
                ...
                t.webView = (o || s || n) && e.match(/.*AppleWebKit(?!.*Safari)/i),
            t.os && "ios" === t.os) {
            ...
            if (s.noSwiping && e(n).closest("." + s.noSwipingClass)[0])
                ...
                if (!(x.ios && s.iOSEdgeSwipeDetection && o <= s.iOSEdgeSwipeThreshold)) {
                    if (l.extend(i, {
                        ...
                        "touchstart" !== n.type) {
                        var p = !0;
                        e(n.target).is(i.formElements) && (p = !1),
                        document.activeElement && e(document.activeElement).is(i.formElements) && document.activeElement.blur(),
                        p && n.preventDefault()
                    }
                    a.emit("touchStart", n)
                }
        ...
        if (o.originalEvent && (o = o.originalEvent),
            ...
            if (i.isTouchEvent && s.touchReleaseOnEdges && !s.loop)
                if (a.isVertical()) {
                    ...
                    return;
            if (i.isTouchEvent && document.activeElement && o.target === document.activeElement && e(o.target).is(i.formElements))
                return i.isMoved = !0,
                    void (a.allowClick = !1);
            if (i.allowTouchCallbacks && a.emit("touchMove", o),
                ...
                if (r.currentX = "touchmove" === o.type ? o.targetTouches[0].pageX : o.pageX,
                    ...
                    var c;
                    a.isHorizontal() && r.currentY === r.startY || a.isVertical() && r.currentX === r.startX ? i.isScrolling = !1 : (c = 180 * Math.atan2(Math.abs(r.currentY - r.startY), Math.abs(r.currentX - r.startX)) / Math.PI,
                ...
                if (i.isScrolling && a.emit("touchMoveOpposite", o),
                    ...
                    if (i.isScrolling)
                        ...
                        i.isMoved || (s.loop && a.loopFix(),
                            ...
                            a.setTransition(0),
                        a.animating && a.$wrapperEl.trigger("webkitTransitionEnd transitionend oTransitionEnd MSTransitionEnd msTransitionEnd"),
                        ...
                        r.diff = u,
                            u *= s.touchRatio,
                        n && (u = -u),
                            a.swipeDirection = u > 0 ? "prev" : "next",
                            i.currentTranslate = u + i.startTranslate;
                        var h = !0
                            , v = s.resistanceRatio;
                        if (s.touchReleaseOnEdges && (v = 0),
                                u > 0 && i.currentTranslate > a.minTranslate() ? (h = !1,
                                s.resistance && (i.currentTranslate = a.minTranslate() - 1 + Math.pow(-a.minTranslate() + i.startTranslate + u, v))) : u < 0 && i.currentTranslate < a.maxTranslate() && (h = !1,
                                    s.resistance && (i.currentTranslate = a.maxTranslate() + 1 - Math.pow(a.maxTranslate() - i.startTranslate - u, v))),
            ...
            if (h = i.followFinger ? r ? t.translate : -t.translate : -a.currentTranslate,
                ...
                if (i.freeModeMomentum) {
                    ...
                    if (x < t.maxTranslate())
                        ...
                        x = Math.abs(d[S] - x) < Math.abs(d[S - 1] - x) || "next" === t.swipeDirection ? d[S] : d[S - 1],
                        r || (x = -x)
                    }
                    if (0 !== t.velocity)
                        b = r ? Math.abs((-x - t.translate) / t.velocity) : Math.abs((x - t.translate) / t.velocity);
                    else if (i.freeModeSticky)
            ...
            attachEvents: function() {
                ...
                if (f.ie)
                    r.addEventListener(a.start, e.onTouchStart, !1),
                        (d.touch ? r : document).addEventListener(a.move, e.onTouchMove, n),
                        (d.touch ? r : document).addEventListener(a.end, e.onTouchEnd, !1);
                else {
                    if (d.touch) {
                    ...
                    (t.simulateTouch && !x.ios && !x.android || t.simulateTouch && !d.touch && x.ios) && (r.addEventListener("mousedown", e.onTouchStart, !1),
                        document.addEventListener("mousemove", e.onTouchMove, n),
                        document.addEventListener("mouseup", e.onTouchEnd, !1))
                }
                (t.preventClicks || t.preventClicksPropagation) && r.addEventListener("click", e.onClick, !0),
                    e.on("resize observerUpdate", S)
            },
            detachEvents: function() {
                ...
                if (f.ie)
                    r.removeEventListener(a.start, e.onTouchStart, !1),
                        (d.touch ? r : document).removeEventListener(a.move, e.onTouchMove, n),
                        (d.touch ? r : document).removeEventListener(a.end, e.onTouchEnd, !1);
                else {
                    if (d.touch) {
                        var o = !("onTouchStart" !== a.start || !d.passiveListener || !t.passiveListeners) && {
                                passive: !0,
                    ...
                    (t.simulateTouch && !x.ios && !x.android || t.simulateTouch && !d.touch && x.ios) && (r.removeEventListener("mousedown", e.onTouchStart, !1),
                        document.removeEventListener("mousemove", e.onTouchMove, n),
                        document.removeEventListener("mouseup", e.onTouchEnd, !1))
                }
                (t.preventClicks || t.preventClicksPropagation) && r.removeEventListener("click", e.onClick, !0),
                    e.off("resize observerUpdate", S)
            }
        },
        breakpoints: {
        ...
        classes: {
            addClasses: function() {
                ...
                d.flexbox || n.push("no-flexbox"),
                a.autoHeight && n.push("autoheight"),
                i && n.push("rtl"),
                a.slidesPerColumn > 1 && n.push("multirow"),
                x.android && n.push("android"),
                x.ios && n.push("ios"),
                (r.navigator.pointerEnabled || r.navigator.msPointerEnabled) && n.push("wp8-" + a.direction),
        ...
        images: {
            loadImage: function(e, t, a, i, s, n) {
                ...
                var l;
                e.complete && s ? o() : t ? ((l = new r.Image).onload = o,
                    l.onerror = o,
                i && (l.sizes = i),
                a && (l.srcset = a),
                t && (l.src = t)) : o()
            ...
            preloadImages: function() {
                ...
                for (var t = 0; t < e.imagesToLoad.length; t += 1) {
                    ...
                    e.loadImage(a, a.currentSrc || a.getAttribute("src"), a.srcset || a.getAttribute("srcset"), a.sizes || a.getAttribute("sizes"), !0, function() {
                        void 0 !== e && null !== e && e && (void 0 !== e.imagesLoaded && (e.imagesLoaded += 1),
        ...
        update: function(e) {
            ...
            if (l.extend(a.virtual, {
                ...
                d === w && p === x && !e)
                return a.slidesGrid !== u && y !== v && a.slides.css(f, y + "px"),
            ...
            if (e)
                ...
                for (var S = d; S <= p; S += 1)
                    (S < w || S > x) && a.$wrapperEl.find("." + a.params.slideClass + '[data-swiper-slide-index="' + S + '"]').remove();
            for (var C = 0; C < c.length; C += 1)
                C >= w && C <= x && (void 0 === p || e ? E.push(C) : (C > p && E.push(C),
                C < d && T.push(C)));
            E.forEach(function(e) {
                ...
                a.$wrapperEl.children(".swiper-slide").css(f, y + "px"),
                t()
        },
        renderSlide: function(t, a) {
            ...
            return s.cache && (i.virtual.cache[a] = r),
                r
        },
        appendSlide: function(e) {
            var t = this;
        ...
        enable: function() {
            var t = this;
            t.keyboard.enabled || (e(document).on("keydown", t.keyboard.handle),
                t.keyboard.enabled = !0)
        },
        disable: function() {
            var t = this;
            t.keyboard.enabled && (e(document).off("keydown", t.keyboard.handle),
        ...
        enable: function() {
            ...
            return "container" !== t.params.mousewheel.eventsTarged && (a = e(t.params.mousewheel.eventsTarged)),
                a.on(G.event, t.mousewheel.handle),
        ...
        disable: function() {
            ...
            var a = t.$el;
            return "container" !== t.params.mousewheel.eventsTarged && (a = e(t.params.mousewheel.eventsTarged)),
                a.off(G.event, t.mousewheel.handle),
        ...
        update: function() {
            ...
            if (a.el && t.pagination.el && t.pagination.$el && 0 !== t.pagination.$el.length) {
                var i, s = t.virtual && t.params.virtual.enabled ? t.virtual.slides.length : t.slides.length, r = t.pagination.$el, n = t.params.loop ? Math.ceil((s.length - 2 * t.loopedSlides) / t.params.slidesPerGroup) : t.snapGrid.length;
                if (t.params.loop ? ((i = Math.ceil((t.activeIndex - t.loopedSlides) / t.params.slidesPerGroup)) > s.length - 1 - 2 * t.loopedSlides && (i -= s.length - 2 * t.loopedSlides),
                    i > n - 1 && (i -= n),
                    i < 0 && "bullets" !== t.params.paginationType && (i = n + i)) : i = void 0 !== t.snapIndex ? t.snapIndex : t.activeIndex || 0,
                    "bullets" === a.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                    var o = t.pagination.bullets;
                    if (a.dynamicBullets && (t.pagination.bulletSize = o.eq(0)[t.isHorizontal() ? "outerWidth" : "outerHeight"](!0),
                            r.css(t.isHorizontal() ? "width" : "height", 5 * t.pagination.bulletSize + "px")),
                            o.removeClass(a.bulletActiveClass + " " + a.bulletActiveClass + "-next " + a.bulletActiveClass + "-next-next " + a.bulletActiveClass + "-prev " + a.bulletActiveClass + "-prev-prev"),
                        r.length > 1)
                        o.each(function(t, s) {
                            var r = e(s);
                            r.index() === i && (r.addClass(a.bulletActiveClass),
                            a.dynamicBullets && (r.prev().addClass(a.bulletActiveClass + "-prev").prev().addClass(a.bulletActiveClass + "-prev-prev"),
                                r.next().addClass(a.bulletActiveClass + "-next").next().addClass(a.bulletActiveClass + "-next-next")))
                        });
                    else {
                        var l = o.eq(i);
                        l.addClass(a.bulletActiveClass),
                        a.dynamicBullets && (l.prev().addClass(a.bulletActiveClass + "-prev").prev().addClass(a.bulletActiveClass + "-prev-prev"),
                            l.next().addClass(a.bulletActiveClass + "-next").next().addClass(a.bulletActiveClass + "-next-next"))
                    }
                    if (a.dynamicBullets) {
                ...
                if ("fraction" === a.type && (r.find("." + a.currentClass).text(i + 1),
                        r.find("." + a.totalClass).text(n)),
                    "progressbar" === a.type) {
                    var p = (i + 1) / n
                        , c = p
                        , u = 1;
                    t.isHorizontal() || (u = p,
                        c = 1),
                        r.find("." + a.progressbarFillClass).transform("translate3d(0,0,0) scaleX(" + c + ") scaleY(" + u + ")").transition(t.params.speed)
                }
                "custom" === a.type && a.renderCustom ? (r.html(a.renderCustom(t, i + 1, n)),
        ...
        render: function() {
            ...
            if (t.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
                var a = e.virtual && e.params.virtual.enabled ? e.virtual.slides.length : e.slides.length
                    ...
                    , s = "";
                if ("bullets" === t.type) {
                    for (var r = e.params.loop ? Math.ceil((a.length - 2 * e.loopedSlides) / e.params.slidesPerGroup) : e.snapGrid.length, n = 0; n < r; n += 1)
        ...
        setTranslate: function() {
            ...
            if (e.params.scrollbar.el && e.scrollbar.el) {
                var t = e.scrollbar
                    ...
                    , p = s
                    , c = (r - s) * i;
                a && e.isHorizontal() ? (c = -c) > 0 ? (p = s - c,
                    c = 0) : -c + s > r && (p = r + c) : c < 0 ? (p = s + c,
                    c = 0) : c + s > r && (p = r - c),
                    e.isHorizontal() ? (d.transforms3d ? n.transform("translate3d(" + c + "px, 0, 0)") : n.transform("translateX(" + c + "px)"),
                        n[0].style.width = p + "px") : (d.transforms3d ? n.transform("translate3d(0px, " + c + "px, 0)") : n.transform("translateY(" + c + "px)"),
                        n[0].style.height = p + "px"),
        ...
        init: function() {
            ...
            if (t.params.scrollbar.el) {
                ...
                0 === o.length && (o = e('<div class="swiper-scrollbar-drag"></div>'),
                    n.append(o)),
                    t.scrollbar.dragEvents = !1 !== t.params.simulateTouch || d.touch ? s : {
                        start: "mousedown",
                        move: "mousemove",
                        end: "mouseup"
                    },
        ...
        setTransform: function(t, a) {
            ...
            if (l || d ? (l = l || "0",
                ...
                "undefined" != typeof pOpacity && null !== c) {
                var u = c - (c - 1) * (1 - Math.abs(a));
                r[0].style.opacity = u
            }
            if ("undefined" == typeof pScale || null === p)
        ...
        onGestureStart: function(t) {
            ...
            s.$slideEl && s.$slideEl.length || (s.$slideEl = e(this),
            ...
            0 !== s.$imageWrapEl.length) ? (s.$imageEl.transition(0),
                a.zoom.isScaling = !0) : s.$imageEl = void 0
        },
        onGestureChange: function(e) {
            ...
            s.$imageEl && 0 !== s.$imageEl.length && (d.gestures ? t.zoom.scale = e.scale * i.currentScale : i.scale = s.scaleMove / s.scaleStart * i.currentScale,
        ...
        onGestureEnd: function(e) {
            var t = this
                ...
                , i = t.zoom
                , s = i.gesture;
            !d.gestures && ("touchend" !== e.type || "touchend" === e.type && e.changedTouches.length < 2) || s.$imageEl && 0 !== s.$imageEl.length && (i.scale = Math.max(Math.min(i.scale, s.maxRatio), a.minRatio),
        ...
        enable: function() {
            ...
            if (!a.enabled) {
                ...
                d.gestures ? (i.on("gesturestart", a.onGestureStart, s),
        ...
        disable: function() {
            ...
            if (a.enabled) {
                ...
                d.gestures ? (i.off("gesturestart", a.onGestureStart, s),
        ...
        load: function() {
            ...
            if ("auto" === o && (o = 0),
                ...
                a.children("." + i.slideVisibleClass).each(function(a, i) {
                    t.lazy.loadImagesInSlide(e(i).index())
                });
            else if (o > 1)
                for (var l = r; l < r + o; l += 1)
                    s[l] && t.lazy.loadImagesInSlide(l);
            else
                t.lazy.loadImagesInSlide(r);
            if (n.loadPrevNext)
                if (o > 1 || n.loadPrevNextAmount && n.loadPrevNextAmount > 1) {
                    for (var d = n.loadPrevNextAmount, p = o, c = Math.min(r + p + Math.max(d, p), s.length), u = Math.max(r - Math.max(p, d), 0), h = r + o; h < c; h += 1)
                        s[h] && t.lazy.loadImagesInSlide(h);
                    for (var v = u; v < r; v += 1)
                        s[v] && t.lazy.loadImagesInSlide(v)
                } else {
        ...
        setTranslate: function(e, t) {
            ...
            if (Array.isArray(n))
                for (var o = 0; o < n.length; o += 1)
                    n[o] !== t && n[o]instanceof k && a(n[o]);
            else
                n instanceof k && t !== n && a(n)
        },
        setTransition: function(e, t) {
            function a(t) {
                t.setTransition(e, s),
            ...
            if (Array.isArray(r))
                for (i = 0; i < r.length; i += 1)
                    r[i] !== t && r[i]instanceof k && a(r[i]);
            else
                r instanceof k && t !== r && a(r)
        }
    }
        , te = {
        name: "controller",
            ...
            if (a.transition(e),
                ...
                a.transitionEnd(function() {
                    if (!s && t) {
                        s = !0,
                            t.animating = !1;
                        for (var e = ["webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd"], a = 0; a < e.length; a += 1)
                            i.trigger(e[a])
                    }
                })
            }
            ...
            for (var v = 0; v < r.length; v += 1) {
                ...
                if (x <= 1 && x > -1 && (h = 90 * g + 90 * x,
                    ...
                    0 === M.length && (M = e('<div class="swiper-slide-shadow-' + (c ? "right" : "bottom") + '"></div>'),
                        m.append(M)),
                    C.length && (C[0].style.opacity = Math.max(-x, 0)),
                    M.length && (M[0].style.opacity = Math.max(x, 0))
                }
            }
            if (s.css({
            ...
            if (i.transition(t).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").transition(t),
                ...
                i.eq(s).transitionEnd(function() {
                    if (!n && a && e(this).hasClass(a.params.slideActiveClass)) {
                        n = !0,
                            a.animating = !1;
                        for (var t = ["webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd"], i = 0; i < t.length; i += 1)
                            r.trigger(t[i])
                    }
                })
            }
    ...
    return k.components = [$, I, L, D, H, A, N, B, R, F, q, U, Z, J, te, ie, re, oe, de, ce, he, fe, ge],
        k
});
